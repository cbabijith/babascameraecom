...
type PaymentMethod = "RAZORPAY" | "BANK_TRANSFER" | "COD";
    ...
    <div className={`bg-white border border-[#E4E4E7] p-4 sm:p-5 sticky top-20 mb-4 rounded-[20px] ${className}`}>
      ...
      {showDetails && (
        <div className="space-y-3 mb-4 pb-4 border-b border-[#E4E4E7]">
          ...
          {discount > 0 && (
            <div className="flex justify-between items-center">
              <span className="text-[15px] font-[400] text-green-700">Discount</span>
              <span className="text-[14px] font-[500] text-green-700">
                -{rupee(discount)}
              </span>
            </div>
          )}
          ...
          {tax > 0 && (
            <div className="flex justify-between items-center">
              <span className="text-[15px] font-[400] text-[#3A3A3C]">Tax</span>
       ...
       {showPaymentSection && (
        <div className="mb-4">
          ...
          <div className="space-y-2">
            ...
            <label className={`flex items-start gap-3 p-3 rounded-[20px] border ${paymentMethod === "BANK_TRANSFER" ? "border-[#EC134A]" : "border-[#E4E4E7]"} cursor-pointer`}>
              ...
              <div className="flex-1 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[14px] font-[600] text-[#1E293B]">Bank Transfer</p>
                  <p className="text-[12px] text-[#6B7280]">
                    Pay directly using the configured store bank details.
                  </p>
                  {avoidedFee > 0 && (
            ...
            <label className={`flex items-start gap-3 p-3 rounded-[20px] border ${isCod ? "border-[#EC134A]" : "border-[#E4E4E7]"} cursor-pointer`}>
              <input
                type="radio"
                name="payMethod"
                className="mt-[3px]"
              ...
              <div>
                ...
                <p className="text-[12px] text-[#6B7280]">
                  Pay when your eligible order arrives. Availability is confirmed securely before the order is created.
                </p>
              </div>
            </label>
          </div>
