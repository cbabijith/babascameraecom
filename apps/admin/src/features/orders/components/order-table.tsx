  ...
  return (
    <div className="grid gap-4">
      <div className="flex flex-wrap justify-end gap-2">
        ...
        <label className="flex items-center gap-2 text-xs font-semibold text-slate-500">
          To <input type="date" value={dateTo} min={dateFrom || undefined} onChange={(event) => setDateTo(event.target.value)} className="h-10 rounded-md border bg-white px-2 text-slate-900" />
        </label>
      </div>
